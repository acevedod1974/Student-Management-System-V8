...
export const GradesTable: React.FC<GradesTableProps> = ({
  ...
  const handleDeleteExam = (index: number) => {
    if (
      window.confirm(
        "¿Está seguro de eliminar este examen? Esta acción no se puede deshacer."
      )
    ) {
                  ...
                  {editingExam?.index === index ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        aria-label="Guardar nombre del examen"
                      >
                      ...
                      <button
                        ...
                        aria-label="Cancelar edición del nombre del examen"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                    ...
                    <>
                      ...
                      <div className="flex gap-1">
                        <button
                          ...
                          aria-label={`Editar nombre del examen ${exam}`}
                        >
                        ...
                        <button
                          ...
                          className="p-1 text-red-600 hover:bg-red-50 rounded-full transition-colors"
                          aria-label={`Eliminar examen ${exam}`}
                        >
            ...
            <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  editingCell?.gradeId === grade.id ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1 text-red-600 hover:bg-red-50 rounded-full transition-colors"
                        aria-label="Cancelar edición de calificación"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <button
                  ...
                  aria-label={`Eliminar estudiante ${student.firstName} ${student.lastName}`}
                >
      ...
      <div className="mt-4">
        {showAddExam ? (
          ...
          <button
            ...
            aria-label="Agregar nuevo examen"
          >
